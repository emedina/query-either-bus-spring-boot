 ...
 */
public class AnotherTestQueryHandler implements QueryHandler<Throwable, Integer, AnotherTestQuery> {
    ...
    @Override
    public Either<Throwable, Integer> handle(AnotherTestQuery query) {
